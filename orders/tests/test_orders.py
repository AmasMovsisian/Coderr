...
class OrderTests(BaseAPITestCase):
    ...
    def setUp(self):
        ...
        response = self.client.post(
            "/api/offers/", self.offer_payload, format="json")
        ...
        response = self.client.post(
            self.orders_url, self.order_payload, format="json")
    ...
    def test_patch_order_status_success(self):
        ...
        response = self.client.patch(
            f"{self.orders_url}{self.order_id}/", payload, format="json")
    ...
    def test_order_count_success(self):
        ...
        response = self.client.get(
            f"{self.order_count_url}{self.business.id}/")
    ...
    def test_completed_order_count_success(self):
        ...
        self.authenticate(self.customer_token)
        response = self.client.get(
            f"{self.completed_order_count_url}{self.business.id}/")
